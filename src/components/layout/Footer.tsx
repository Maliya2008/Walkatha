...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer
      id="main-app-footer"
      className="w-full border-t border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 py-6 sm:py-8 transition-colors"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              {categories
                ...
                .map((cat) => (
                  <button
                    ...
                    className="text-left text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors py-0.5 cursor-pointer truncate"
                  >
                    • {cat.name}
                  </button>
                ))}
        ...
        {/* Bottom Bar */}
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-slate-400">
          <div>
